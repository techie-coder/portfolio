...
const NavBar = () => {
	return (
		...
		<a className="p-3 m-3 hover:text-yellow" href='#'>Home</a>
		<a className="p-3 m-3 hover:text-yellow" href='#'>Works</a>
		<a className="p-3 m-3 hover:text-yellow" href='#'>Contact</a>
		</div>
		</nav>
	)
}
